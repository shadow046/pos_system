<script setup>
    ...
    function destroy(id) {
        swal({
            ...
            if(res)
            {
                axios.delete(route('categories.delete', props.category.uuid))
                    .then(res => {
                        form.reset();
                        swal({
                            icon: 'success',
    ...
    <tr class="text-gray-700">
        ...
        <td class="px-4 py-3 text-sm">
            ...
            <button class="truncate">
                <span class="text-red-500 hover:text-red-700 font-medium" @click="destroy(category.uuid)">Remove</span>
            </button>
        </td>
    </tr>
