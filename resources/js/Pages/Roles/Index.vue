    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 lg:ml-60 md:ml-64">
                <Table :title="'Roles'" :description="'Showing roles'">
                    <template #action>
                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y" v-if="roles.data.length > 0">
                            <Role v-for="role in roles.data"
                                :key="role.id"
                                :role="role">
                            </Role>
                        </tbody>
